...
public class FileInput {
    ...
    /**
     * Reads the file at the given path and returns contents of it in a String list.
     *
     ...
     * @return Contents of the file as a list, returns null if there is not such a file or this program does not have sufficient permissions to read that file.
     */
    public static List<String> readFile(String path, boolean discardEmptyLines, boolean trim) {
        try {
            lines = Files.readAllLines(Paths.get(path)); //Gets the content of file to the list.
